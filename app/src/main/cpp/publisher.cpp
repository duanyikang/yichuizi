...
Java_com_yichuizi_yichuizi_nativeclass_Publisher_initVideo(JNIEnv *env, jobject instance,
                                                           jstring url_) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_yichuizi_yichuizi_nativeclass_Publisher_onFrameCallback(JNIEnv *env, jobject instance,
                                                                 jbyteArray buffer_) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_yichuizi_yichuizi_nativeclass_Publisher_close(JNIEnv *env, jobject instance) {
    if (video_st)
