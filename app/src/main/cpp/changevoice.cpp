...
Java_com_yichuizi_yichuizi_nativeclass_ChangeVoice_paySound(JNIEnv *env, jobject instance, jstring path_, jint type) {
    System *system;
    Sound *sound;
    Channel *channel;
    DSP *dsp;
