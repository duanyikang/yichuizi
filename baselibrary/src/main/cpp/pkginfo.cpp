...
Java_com_yichuizi_baselibrary_PkgInfoUtil_getPkgName(JNIEnv *env, jobject instance) {
    // 获取包名
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_yichuizi_baselibrary_PkgInfoUtil_getSign(JNIEnv *env, jobject instance, jobject context) {
    // 获取签名
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_yichuizi_baselibrary_PkgInfoUtil_getPSMd5(JNIEnv *env, jobject instance, jstring str_) {
    // TODO
    env->ReleaseStringUTFChars(str_, 0);
